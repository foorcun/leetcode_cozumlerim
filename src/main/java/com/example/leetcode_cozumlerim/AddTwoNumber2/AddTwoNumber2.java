...
////
////    int val;
////    com.example.leetcode_cozumlerim.ReorderList143.ListNode next;
////    ListNode() {}
////    ListNode(int val) { this.val = val; }
////    ListNode(int val, com.example.leetcode_cozumlerim.ReorderList143.ListNode next) { this.val = val; this.next = next; }
////}